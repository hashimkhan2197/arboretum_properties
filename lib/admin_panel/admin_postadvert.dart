...
class AdminPostAdvert extends StatefulWidget {
  final AsyncSnapshot userSnapshot;
  AdminPostAdvert(this.userSnapshot);

  @override
  _AdminPostAdvertState createState() => _AdminPostAdvertState();
}

class _AdminPostAdvertState extends State<AdminPostAdvert> {
  @override
  //multi image picker
  ...
  bool studentRoomsCheckbox = false;
  bool professionalRoomsCheckbox = false;
  bool shortTermStayCheckbox = false;
  bool apartmentsCheckbox = false;
  //bottom sheet selectors
  int typeOfPropertySelector = 1;
  String typeOfPropertyString = 'House';
  int sizeOfPropertySelector = 1;
  String sizeOfPropertyString = '1 Bed';
  int typeOfRoomSelector = 1;
  String typeOfRoomString = 'Double bed room';

  ///Amenities
  //checkboxes
  bool livingRoomCheckbox = false;
  bool gardenCheckbox = false;
  bool balconyCheckbox = false;
  bool parkingCheckbox = false;
  bool garageCheckBox = false;
  bool disabledAccessCheckbox = false;
  //bottom sheet selectors
  int furnishingsSelector = 1;
  String furnishingsString = 'Furnished';
  int billsIncludedSelector = 1;
  String billsIncludedString = 'Yes';
  int broadbandSelector = 1;
  String broadbandString = 'Yes';

  var perWeekSelector = 1;
  String perWeekString = 'per day';
  DateTime _dateTime= DateTime.now();
  List<DateTime> _multiDateList = List<DateTime>();
  ///Existing Flatmates
  //bottom sheet selectors
  int otherFlatmatesGenderSelector = 1;
  String otherFlatmatesGenderString = 'Male';
  int otherFlatmatesOccupationSelector = 1;
  String otherFlatmatesOccupationString = 'Students';
  int otherFlatmatesSmokingSelector = 1;
  String otherFlatmatesSmokingString = 'Yes';
  int otherFlatmatesPetsSelector = 1;
  String otherFlatmatesPetsString = 'Yes';
  /// New Flatmates Preferences
  //bottom sheet selectors
  int newFlatmatesGenderSelector = 1;
  String newFlatmatesGenderString = 'Male';
  int newFlatmatesOccupationSelector = 1;
  String newFlatmatesOccupationString = 'Students';
  int newFlatmatesSmokingSelector = 1;
  String newFlatmatesSmokingString = 'Yes';
  int newFlatmatesPetsSelector = 1;
  String newFlatmatesPetsString = 'Yes';
  int newFlatmatesCoupleWelcomeSelector = 1;
  String newFlatmatesCouplesWelcomeString = 'Yes';


  ///Text Controllers
  TextEditingController addressController = TextEditingController(text: '');
  TextEditingController securityDepositController = TextEditingController(text: '');
  ...
  TextEditingController existingFlatmatesMinAgeController = TextEditingController(text: '');
  TextEditingController existingFlatmatesMaxAgeController = TextEditingController(text: '');
  TextEditingController newFlatmatesMinAgeController = TextEditingController(text: '');
  TextEditingController newFlatmatesMaxAgeController = TextEditingController(text: '');
                  ...
                  if (addressController.text == ""){
                    ...
                    for (Asset image in images){
                      ...
                      try{
                        ...
                        String fileName = '${image.name+DateTime.now().toString()}.png';
                    ...
                    Firestore.instance.collection('properties').add({
